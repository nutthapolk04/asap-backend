  ...
  <div class="contact-submissions">
    ...
    <div class="content-card">
      ...
      >
        ...
        <el-table-column label="วันที่" width="160">
          <template #default="{ row }">
            {{ formatDateTime(row.createdAt) }}
          </template>
        </el-table-column>

        <el-table-column label="ชื่อ-นามสกุล" width="180">
          <template #default="{ row }">
            {{ row.firstName }} {{ row.lastName }}
          </template>
        </el-table-column>

        <el-table-column prop="email" label="อีเมล" min-width="200" />

        <el-table-column prop="phone" label="เบอร์โทร" width="140" />

        <el-table-column prop="subject" label="หัวข้อ" min-width="200">
          <template #default="{ row }">
