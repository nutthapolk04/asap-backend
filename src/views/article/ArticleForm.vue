        ...
        <el-col :span="8">
          <div class="content-card">
            <div class="form-section">
              ...
              <el-form-item label="วันที่เผยแพร่" prop="publishedDate">
                <el-date-picker
            ...
            <div class="form-section">
              ...
              <el-form-item prop="coverImage">
                <div class="image-upload-wrapper">
                  ...
                  <div class="image-hint">แนะนำขนาด: 302 x 302 px</div>
                </div>
              </el-form-item>
            </div>
...
const { getArticle, getArticleCategories, createArticle, updateArticle } = useApi()
