<template>
  <div class="promotion-form">
    <div class="page-header">
      <h1>{{ isEdit ? 'แก้ไขโปรโมชั่น' : 'เพิ่มโปรโมชั่น' }}</h1>
    </div>
    ...
    >
      <div class="form-section">
        ...
        <el-form-item label="ชื่อโปรโมชั่น (สำหรับ Admin)" prop="title">
          <el-input
            v-model="form.title"
      ...
      <div class="form-section">
        <div class="form-section-title">รูปภาพโปรโมชั่น</div>
...
const rules = {
  title: [
    { required: true, message: 'กรุณากรอกชื่อโปรโมชั่น', trigger: 'blur' }
  ],
  image: [
    ...
    if (valid) {
      ...
      try {
        if (isEdit.value) {
          ...
          ElMessage.success('แก้ไขโปรโมชั่นสำเร็จ')
        } else {
          await createPromotion(form)
          ElMessage.success('สร้างโปรโมชั่นสำเร็จ')
        }
  ...
  if (isEdit.value) {
    try {
      ...
      if (data) {
        ...
        ElMessage.error('ไม่พบข้อมูลโปรโมชั่น')
        router.push('/promotions')
      }
    } catch (error) {
