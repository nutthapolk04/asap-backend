  ...
  <div class="promotion-list">
    <div class="page-header">
      ...
      >
        ...
        <span style="margin-left: 6px;">เพิ่มโปรโมชั่น</span>
      </el-button>
    </div>
    ...
    <div class="content-card">
      <div class="card-toolbar">
        ...
        <el-alert
          ...
          title="ถึงจำนวนสูงสุดแล้ว (3 โปรโมชั่น)"
          type="warning"
          :closable="false"
          show-icon
          style="width: auto;"
      ...
      >
        ...
        <el-table-column prop="title" label="ชื่อโปรโมชั่น" min-width="180" />
...
const { getPromotions, updatePromotion, deletePromotion } = useApi()
...
const handleDelete = async (row) => {
  try {
    await ElMessageBox.confirm(
      `คุณต้องการลบโปรโมชั่น "${row.title}" ใช่หรือไม่?`,
      'ยืนยันการลบ',
      {
    ...
    ElMessage.success('ลบโปรโมชั่นสำเร็จ')
    fetchPromotions()
  } catch (error) {
    if (error !== 'cancel') {
