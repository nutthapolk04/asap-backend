  ...
  <div class="brand-detail">
    ...
    >
      <div class="image-management">
        ...
        >
          <template #title>
            อัปโหลดรูปภาพได้สูงสุด 6 รูป ลำดับการแสดงผลจะเรียงตาม รูป 1, 2, 3, 4, 5, 6
          </template>
        </el-alert>
      ...
      <template #footer>
        <el-button @click="imageDialogVisible = false">ยกเลิก</el-button>
        <el-button type="primary" @click="saveImages" :loading="saving">
          บันทึก
        </el-button>
      </template>
    </el-dialog>
